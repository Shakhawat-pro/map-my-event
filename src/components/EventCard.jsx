            ...
            <div className='2 w-full'>
                <div className='flex justify-between w-full'>
                    ...
                    <div className='space-y-2 flex items-center justify-center  h-fit gap-2 max-lg:hidden'>
                        ...
                        <button className="whitespace-nowrap px-4 py-2 bg-white text-black border-1 border-base-300  shadow-xs flex flex-row items-center justify-center gap-1 rounded-lg">
                ...
                <div className='space-y-2 flex flex-row  items-center h-fit gap-2 lg:hidden mt-5'>
                    <button className="px-4 py-2 m-0 bg-white text-black border-1 border-base-300  shadow-xs flex flex-row items-center justify-center gap-1 rounded-lg">
                        More info <FiExternalLink />
                    </button>
