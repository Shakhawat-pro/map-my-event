...
const Navbar = () => {
    ...
    const navLink = <>
        <li className='max-lg:btn'><NavLink to={'/'} className={"border-2 border-transparent"}>{t('common.home')}</NavLink></li>
        <li className='max-lg:btn'><NavLink to={'map'} className={"border-2 border-transparent"}>{t('common.find_event')}</NavLink></li>
        <li className='max-lg:btn'><NavLink to={"calender"} className={"border-2 border-transparent"}>{t('common.calendar')}</NavLink></li>
    </>;
...
<div className="sm:navbar-start flex items-center gap-1">
  ...
  <div className="dropdown nav-container">
    ...
    <button 
      tabIndex={0} 
      role="button" 
      className="lg:hidden btn btn-ghost p-1 mt-2 border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                ...
                <div className="dropdown dropdown-end">
                    ...
                    {user !== null ?
                        ...
                        <ul tabIndex={0} className="menu menu-md dropdown-content bg-base-100 rounded-box z-50 mt-3 w-52 p-2 shadow-2xl border-1 border-base-300 gap-1" >
                            <li className='btn'><NavLink to={'/login'}>{t('common.login')}</NavLink></li>
                            <li className='btn'><NavLink to={'/register'}>{t('common.register')}</NavLink></li>
                        </ul>
                    }
                </div>
            </div>
