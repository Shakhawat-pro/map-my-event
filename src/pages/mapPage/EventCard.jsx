        ...
        <div className="flex justify-between gap-2 border-1 border-base-300 rounded-2xl shadow-sm overflow-hidden p-4">
            ...
            <div>
                <div className='flex justify-between'>
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800 ">AIMS Conference 2025</h1>
                        <ul className="space-y-2">
                            <li className="flex items-center">
                                <li className="ml-2 flex items-center justify-center gap-2 text-gray-700"><FaRegCalendarAlt />July 2–5, 2025</li>
                            </li>
                            <li className="flex items-center">
                                <span className="ml-2 flex items-center justify-center gap-2 text-gray-700"><IoLocationOutline className="text-xl -ml-[1px]" />Paris, University Dauphine</span>
                            </li>
                        </ul>
                    </div>
